			  						...
			  						<div class="row">
			  							<div class="col-lg-3 col-md-6 col-sm-12">
			  								<div class="form-group m-all-15">
				  								<label for="invoiceNo">Invoice Number&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></label>
			  							...
			  							<div class="col-lg-3 col-md-6 col-sm-12">
			  								<div class="form-group m-all-15">
				  								<label for="invoiceDate">Invoice Date&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></label>
			  							...
			  							<div class="col-lg-3 col-md-6 col-sm-12">
			  								<div class="form-group m-all-15">
				  								<label for="stateOfSupply">State of Supply&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></label>
			  							...
			  							<div class="col-lg-3 col-md-6 col-sm-12">
			  								<div class="form-group m-all-15">
				  								<label for="placeOfSupply">Place of Supply&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></label>
			  								...
			  								<table class="table table-borderless borderless" id="itemTable">
				  								<thead>
				  									<tr>
				  										...
				  										<th class="text-center">Item&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></th>
				  										<th class="text-center">HSN Code</th>
				  										<th class="text-center">Quantity&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></th>
				  										<th class="text-center">Rate&nbsp;<i class="fa fa-asterisk mandatory icon-small"></i></th>
