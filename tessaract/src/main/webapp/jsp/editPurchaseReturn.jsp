	...
	<div class="container-fluid">
		...
		<div class="row">
			<form action="savePurchReturnDetails">
				<s:hidden name="purchaseBean.purchaseId" />
				<s:hidden name="purchaseRetAmtBean.purchaseAmountId" />
				<div class="col-xs-12">
						...
						<tbody>
								...
								<s:iterator value="PurchaseRetlist" status="row">
									<tr>
										...
										<td><input class="form-control" type="text"
											name="PurchaseRetlist[<s:property value="#row.index"/>].hsnCode"
							...
							<tr>
								...
								<td colspan="1"><input class="form-control" id="totamt"
									type="text" name="purchaseRetAmtBean.grossamount"
									value="<s:property value="purchaseRetAmtBean.grossamount"/>" /></td>
							</tr>
							<tr>
								...
								<td colspan="1"><input class="form-control" id="roundoff"
									...
									value="<s:property value="purchaseRetAmtBean.roundoff"/>"
							...
							<tr>
								...
								<td colspan="1"><input class="form-control" id="totnetamt"
									type="text" name="purchaseRetAmtBean.netamount"
									value="<s:property value="purchaseRetAmtBean.netamount"/>" /></td>
							</tr>
						</tbody>
